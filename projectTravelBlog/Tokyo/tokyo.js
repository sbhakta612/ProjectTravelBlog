...
fetch(
  "https://api.openweathermap.org/data/3.0/onecall?lat=35.67&lon=139.65&units=metric&appid=36d197eb10a0afdeece4668f3a6a3c70"
...
const map = new mapboxgl.Map({
  ...
  center: [139.6503106, 35.6761919],
  zoom: 10,
});

const marker1 = new mapboxgl.Marker();
marker1.setLngLat([139.6503106, 35.6761919]);
