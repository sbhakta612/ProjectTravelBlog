...
fetch(
  "https://api.openweathermap.org/data/3.0/onecall?lat=35.21&lon=129.06&units=metric&appid=36d197eb10a0afdeece4668f3a6a3c70"
...
const map = new mapboxgl.Map({
  ...
  center: [129.0688702, 35.2100142],
  zoom: 10,
});

const marker1 = new mapboxgl.Marker();
marker1.setLngLat([129.0688702, 35.2100142]);
