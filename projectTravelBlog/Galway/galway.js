...
fetch(
  "https://api.openweathermap.org/data/3.0/onecall?lat=53.27&lon=-9.05&units=metric&appid=36d197eb10a0afdeece4668f3a6a3c70"
...
const map = new mapboxgl.Map({
  ...
  center: [-9.0512662, 53.274001],
  zoom: 10,
});

const marker1 = new mapboxgl.Marker();
marker1.setLngLat([-9.0512662, 53.274001]);
